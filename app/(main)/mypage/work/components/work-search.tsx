...
import { SearchProps, initialSearch } from "./work-container";
import {
  WorkerTaskStatusType,
  WorkerTaskStatusTypeEnum,
...
const workSelectOption = Object.keys(WorkerTaskStatusType).map((key) => {
  return { value: key, label: WorkerTaskStatusTypeEnum.get(key) };
});

// 메인 컴포넌트
export const WorkSearch = ({ setSearch, search }: Props) => {
  // 날짜기간 열고 닫기 상태 관리
